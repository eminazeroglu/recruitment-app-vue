...
const translateKey = 'crm.EducationDegree';

export default {
    name: "EducationDegreeIndex",
    data() {
        return {
            translateKey,
            modalId,
    ...
    methods: {
        ...mapActions('EducationDegreeStore', ['getEducationDegrees', 'setEducationDegree', 'actionEducationDegree', 'deleteEducationDegree']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        save() {
            this.setEducationDegree(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
