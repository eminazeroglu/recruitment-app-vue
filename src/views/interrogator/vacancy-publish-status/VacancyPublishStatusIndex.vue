<template>
    <page>
        ...
        <page-body>
            <data-grid
                :data-source="vacancyPublishStatuses"
                :columns="columns"
...
const translateKey = 'crm.VacancyPublishStatus';

export default {
    name: "VacancyPublishStatusIndex",
    data() {
        return {
            translateKey,
            modalId,
    ...
    methods: {
        ...mapActions('VacancyPublishStatusStore', ['getVacancyPublishStatuses', 'setVacancyPublishStatus', 'actionVacancyPublishStatus', 'deleteVacancyPublishStatus']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        save() {
            this.setVacancyPublishStatus(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
                }
