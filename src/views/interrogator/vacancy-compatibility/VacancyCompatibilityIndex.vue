<template>
    <page>
        ...
        <page-body>
            <data-grid
                :data-source="vacancyCompatibilities"
                :columns="columns"
...
const translateKey = 'crm.VacancyCompatibility';

export default {
    name: "VacancyCompatibilityIndex",
    data() {
        return {
            translateKey,
            modalId,
    ...
    methods: {
        ...mapActions('VacancyCompatibilityStore', ['getVacancyCompatibilities', 'setVacancyCompatibility', 'actionVacancyCompatibility', 'deleteVacancyCompatibility']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteVacancyCompatibility(id).then(r => this.getVacancyCompatibilities()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionVacancyCompatibility({id: item.id, type, action}).then(r => this.getVacancyCompatibilities())
        },
        /*
         * Save
         * */
        save() {
            this.setVacancyCompatibility(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
                    this.getVacancyCompatibilities();
                }
            })
        }
    },
