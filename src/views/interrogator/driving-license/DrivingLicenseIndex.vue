...
const translateKey = 'crm.DrivingLicense';

export default {
    name: "DrivingLicenseIndex",
    data() {
        return {
            translateKey,
            modalId,
    ...
    computed: {
        ...mapState('DrivingLicenseStore', ['drivingLicenses']),
        permission() {
            return this.currentPage.permission;
        }
    },
    methods: {
        ...mapActions('DrivingLicenseStore', ['getDrivingLicenses', 'setDrivingLicense', 'actionDrivingLicense', 'deleteDrivingLicense']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteDrivingLicense(id).then(r => this.getDrivingLicenses()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionDrivingLicense({id: item.id, type, action}).then(r => this.getDrivingLicenses())
        },
        /*
         * Save
         * */
        save() {
            this.setDrivingLicense(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
