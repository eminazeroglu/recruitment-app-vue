...
const translateKey = 'crm.VacancyStatus';

export default {
    name: "VacancyStatusIndex",
    data() {
        return {
            translateKey,
            modalId,
    ...
    methods: {
        ...mapActions('VacancyStatusStore', ['getVacancyStatuses', 'setVacancyStatus', 'actionVacancyStatus', 'deleteVacancyStatus']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteVacancyStatus(id).then(r => this.getVacancyStatuses()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionVacancyStatus({id: item.id, type, action}).then(r => this.getVacancyStatuses())
        },
        /*
         * Save
         * */
        save() {
            this.setVacancyStatus(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
