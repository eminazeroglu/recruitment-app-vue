        ...
        <page-body>
            ...
            >
                <div slot-scope="list" slot="photoTemplate">
                    <img :src="list.row.photo" class="object-cover w-16 h-16" alt="">
                </div>
                ...
                <form @submit.prevent="save">
                    <grid>
                        ...
                        <form-group
                            ...
                            name="photo_name"
                        >
                            <form-photo :photo="photoView" imgHeight="150px" v-model="form.photo_name"/>
                        </form-group>
...
export default {
    ...
    methods: {
        ...
        formCreate(item = {}) {
            ...
            this.photoView = item.photo || null;
            this.form = form;
            this.modelShow = true;
        },
        /*
