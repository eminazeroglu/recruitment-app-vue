...
const translateKey = 'crm.University';
...
export default {
    ...
    computed: {
        ...mapState('UniversityStore', ['universities']),
        permission() {
            return this.currentPage.permission;
        }
    },
    methods: {
        ...mapActions('UniversityStore', ['getUniversities', 'setUniversity', 'actionUniversity', 'deleteUniversity']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteUniversity(id).then(r => this.getUniversities()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionUniversity({id: item.id, type, action}).then(r => this.getUniversities())
        },
        /*
         * Save
         * */
        save() {
            this.setUniversity(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
