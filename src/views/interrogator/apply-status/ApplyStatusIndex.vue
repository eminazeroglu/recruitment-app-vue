...
const translateKey = 'crm.ApplyStatus';

export default {
    name: "ApplyStatusIndex",
    data() {
        return {
            translateKey,
            modalId,
    ...
    methods: {
        ...mapActions('ApplyStatusStore', ['getApplyStatuses', 'setApplyStatus', 'actionApplyStatus', 'deleteApplyStatus']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteApplyStatus(id).then(r => this.getApplyStatuses()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionApplyStatus({id: item.id, type, action}).then(r => this.getApplyStatuses())
        },
        /*
         * Save
         * */
        save() {
            this.setApplyStatus(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
                    this.getApplyStatuses();
                }
            })
        }
    },
