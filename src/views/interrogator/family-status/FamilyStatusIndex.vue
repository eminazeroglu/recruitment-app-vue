...
const translateKey = 'crm.FamilyStatus';
...
export default {
    ...
    methods: {
        ...mapActions('FamilyStatusStore', ['getFamilyStatuses', 'setFamilyStatus', 'actionFamilyStatus', 'deleteFamilyStatus']),
        /*
         * Form Create
         * */
        formCreate(item = {}) {
         ...
         * */
        remove(id) {
            this.alert().then(r => this.deleteFamilyStatus(id).then(r => this.getFamilyStatuses()))
        },
        /*
         * Action
         * */
        action(item, type) {
            ...
            this.actionFamilyStatus({id: item.id, type, action}).then(r => this.getFamilyStatuses())
        },
        /*
         * Save
         * */
        save() {
            this.setFamilyStatus(this.form)
            .then(r => {
                if (r) {
                    this.modal(this.modalId);
